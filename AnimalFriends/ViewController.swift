...
class ViewController: UIViewController,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    let dollarnames = ["2dollarbill":"two dollar bill.", "1dollarbill":"one dollar bill."]
    ...
    func processFile(image: Data) {
        ...
        let uploadURL = "https://qj9d854kd0.execute-api.us-east-1.amazonaws.com/Predict/e0aad5ee-6238-4e24-ac48-1b5119ac6e9c"
